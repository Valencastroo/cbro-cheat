...
local Window = Library:CreateWindow({
    ...
    LoadingSubtitle = "By cuky2008",
    ConfigurationSaving = {
        Enabled = true,
        FolderName = "CounterBlox", -- Create a custom folder for your hub/game
        FileName = "CukyCounterBlox"
    },
    Discord = {
        Enabled = true,
        Invite = "xM9f3spQAw", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ABCD would be ABCD
    ...
    KeySettings = {
        ...
        Key = {"cukytamaluco"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
    }
})
...
local Creditos = Window:CreateTab("Creditos", 4483362458)
...
if true then
    ...
    do
        ...
        Combat:CreateSection("Configuracion")
        Combat:CreateSlider({
            Name = "Radio del FOV",
            Range = {0, 2000},
            Increment = 1,
        ...
        Combat:CreateSection("Personaje")
        Combat:CreateToggle({
            Name = "Spinbot",
            CurrentValue = false,
            Flag = "Spinbot",
    ...
    do
        ...
        Visuals:CreateSection("Personaje")
        ...
        Visuals:CreateSlider({
            Name = "Distancia Tercera Persona",
            Range = {0, 50},
            Increment = 1,
            CurrentValue = 10,
        ...
        Visuals:CreateSection("Jugadores")
        Visuals:CreateToggle({
            Name = "Chams",
            CurrentValue = false,
            Flag = "Chams",
